...
FlatGridmap2D::FlatGridmap2D(const cslibs_ndt_2d::static_maps::flat::Gridmap::Ptr &map,
...
cslibs_ndt_2d::static_maps::flat::Gridmap::Ptr& FlatGridmap2D::data()
{
    return data_;
}

cslibs_ndt_2d::static_maps::flat::Gridmap::Ptr const& FlatGridmap2D::data() const
{
    return data_;
}
}
