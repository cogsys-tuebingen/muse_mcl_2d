...
public:
    ...
    OccupancyGridmap3d(const cslibs_ndt_3d::dynamic_maps::OccupancyGridmap::Ptr &map,
    ...
    cslibs_ndt_3d::dynamic_maps::OccupancyGridmap::Ptr& data();
    cslibs_ndt_3d::dynamic_maps::OccupancyGridmap::Ptr const& data() const;

private:
    cslibs_ndt_3d::dynamic_maps::OccupancyGridmap::Ptr data_;
};
}
