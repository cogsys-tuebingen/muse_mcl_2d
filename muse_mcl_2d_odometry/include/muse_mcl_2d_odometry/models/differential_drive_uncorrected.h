#ifndef DIFFERENTIAL_DRIVE_UNCORRECTED_H
#define DIFFERENTIAL_DRIVE_UNCORRECTED_H
...
class DifferentialDriveUncorrected : public muse_mcl_2d::PredictionModel2D
{
public:
    DifferentialDriveUncorrected() = default;
...
#endif /* DIFFERENTIAL_DRIVE_UNCORRECTED_H */
