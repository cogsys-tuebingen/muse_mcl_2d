...
CLASS_LOADER_REGISTER_CLASS(muse_mcl_2d_gridmaps::BeamModelAMCL,
                            muse_mcl_2d::UpdateModel2D)

namespace muse_mcl_2d_gridmaps {
BeamModelAMCL::BeamModelAMCL() {}

void BeamModelAMCL::apply(const std::shared_ptr<data_t const> &data,
  ...
  auto probability = [&gridmap, &p_hit, &p_short, &p_max, &p_random,
    ...
    const double map_range =
        std::min(range_max, gridmap.getRange(ray_start_point, ray_end_point));
