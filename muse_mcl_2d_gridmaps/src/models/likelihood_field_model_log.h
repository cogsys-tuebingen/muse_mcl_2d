#ifndef LIKELIHOOD_FIELD_MODEL_LOG_H
#define LIKELIHOOD_FIELD_MODEL_LOG_H

#include <muse_mcl_2d/update/update_model_2d.hpp>

namespace muse_mcl_2d_gridmaps {
class LikelihoodFieldModelLog :  public muse_mcl_2d::UpdateModel2D
{
public:
    LikelihoodFieldModelLog();
...
#endif // LIKELIHOOD_FIELD_MODEL_LOG_H
