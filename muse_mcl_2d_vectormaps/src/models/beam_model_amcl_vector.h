#ifndef BEAM_MODEL_AMCL_VECTOR_H
#define BEAM_MODEL_AMCL_VECTOR_H

#include <muse_mcl_2d/update/update_model_2d.hpp>

namespace muse_mcl_2d_vectormaps {
class BeamModelAMCLVector : public muse_mcl_2d::UpdateModel2D {
public:
...
#endif // BEAM_MODEL_AMCL_VECTOR_H
