#include "likelihood_field_model_amcl_vector.h"
...
CLASS_LOADER_REGISTER_CLASS(muse_mcl_2d_vectormaps::LikelihoodFieldModelAMCLVector, muse_mcl_2d::UpdateModel2D)

namespace muse_mcl_2d_vectormaps {
LikelihoodFieldModelAMCLVector::LikelihoodFieldModelAMCLVector()
{
}

void LikelihoodFieldModelAMCLVector::apply(const data_t::ConstPtr          &data,
...
void LikelihoodFieldModelAMCLVector::doSetup(ros::NodeHandle &nh)
{
